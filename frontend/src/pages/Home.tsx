  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-[60vh] space-y-10 pt-10 pb-16 px-4 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              ...
              {repos.map((repo) => (
                <li key={repo.id}>
                  <Link
                    ...
                    className="flex items-center gap-3 p-3 rounded-lg border border-zinc-100 dark:border-zinc-800 hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-950/20 transition-all group"
                  >
        ...
        {/* Upload Form */}
        <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md transition-shadow">
          ...
          {isUploading ? (
            ...
            <form onSubmit={handleUpload} className="space-y-3 flex flex-col">
              ...
              <input
                type="file"
                accept=".zip"
                className="text-sm text-zinc-500 dark:text-zinc-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-zinc-800 dark:file:text-blue-400"
