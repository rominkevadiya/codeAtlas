...
export default function App() {
 ...
 return (
  <div className="h-screen w-screen bg-black text-white overflow-hidden flex flex-col font-sans selection:bg-zinc-800">
   ...
   <nav className="h-14 shrink-0 bg-zinc-950 border-b border-zinc-800 flex items-center justify-between px-4 z-40 relative shadow-sm">
    ...
    <div className="flex-1 max-w-2xl px-8 relative group">
     ...
     <input 
      ...
      className="w-full bg-black border border-zinc-800 rounded-md py-1.5 pl-10 pr-4 text-sm text-white placeholder:text-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all shadow-sm"
     />
    ...
    <div className="flex items-center gap-2">
     ...
     >
      <span className="text-xs font-bold text-zinc-300">{avatarInitials}</span>
     </button>
    </div>
   </nav>
   ...
   <div className="flex-1 flex overflow-hidden relative">
     ...
     <div className="flex-1 relative z-10">
      {graphData ? (
       ...
       <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-950 z-20 absolute inset-0">
        ...
        <p className="text-2xl font-bold tracking-tight text-white mb-2">Workspace Empty</p>
        ...
        <button 
         ...
         className="bg-white text-black px-6 py-2.5 rounded-lg font-medium hover:bg-zinc-200 transition-colors shadow-sm"
        >
         Connect Repository
        </button>
       </div>
    ...
    {activeRightPanel && (
     <aside className="w-96 shrink-0 bg-zinc-950 border-l border-zinc-800 shadow-[-4px_0_24px_rgba(0,0,0,0.02)] flex flex-col z-30 animate-in slide-in-from-right-2 duration-200 relative">
       ...
       <div className="h-full flex flex-col bg-zinc-950">
        ...
        <div className="p-4 border-b border-zinc-800 flex items-center justify-between bg-black">
         ...
         <button 
          ...
          className="p-1.5 shrink-0 rounded text-slate-400 hover:text-white hover:bg-zinc-800 transition-colors"
         >
          <X className="w-4 h-4" />
         </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-8 custom-scrollbar">
         ...
         <div className="space-y-2">
          <div className="flex items-center justify-between mb-1">
           <h4 className="text-xs font-bold text-white uppercase tracking-wider">Source Code</h4>
         ...
         <div className="space-y-2">
          <div className="flex items-center justify-between mb-1">
           <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
            <Sparkles className="w-3.5 h-3.5 text-white" /> AI Insights
           </h4>
          </div>
