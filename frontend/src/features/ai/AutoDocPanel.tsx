...
export const AutoDocPanel = ({ onClose, repositoryId }: AutoDocPanelProps) => {
 ...
 const panelContent = (
    <motion.div 
      layout
      className={`flex min-w-0 flex-col bg-black shadow-2xl overflow-hidden ${isExpanded ? 'w-full h-full max-w-5xl max-h-[85vh] rounded-2xl mx-auto border border-zinc-800' : 'w-full h-full max-w-full border-l border-zinc-800 z-50'}`}
    >
     <div className="flex justify-between items-center p-4 border-b border-zinc-800 bg-black shrink-0">
   ...
   {/* Content */}
    ...
    <Loader2 className="w-8 h-8 animate-spin text-zinc-500" />
      <div className="text-center">
       <p className="font-medium text-zinc-200 text-sm">Analyzing Repository Architecture</p>
