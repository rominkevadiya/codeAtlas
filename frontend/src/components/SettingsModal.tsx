     ...
     <div className="w-48 border-r border-zinc-800 p-3 flex flex-col gap-1 bg-zinc-950/30 shrink-0">
      <button
       ...
       className={`flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium transition-all ${
        activeTab === 'profile'
         ? 'bg-zinc-950/10 text-white border border-white/10'
      ...
      {activeTab === 'profile' && (
       <div className="space-y-6">
        <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-950/60 border border-zinc-800">
         <div className="w-14 h-14 rounded-full bg-zinc-950 flex items-center justify-center text-xl font-bold text-black shadow-sm">
          {userInitial}
         </div>
         <div>
